...
mod <- lmer(zone.1 ~ period + (1|id), data = training) %>% print()
summary(mod)
pairs(emmeans(mod, specs = ~ period))

mod <- lmer(zone.2 ~ period + (1|id), data = training) %>% print()
summary(mod)
pairs(emmeans(mod, specs = ~ period))

mod <- lmer(zone.3 ~ period + (1|id), data = training) %>% print()
summary(mod)
pairs(emmeans(mod, specs = ~ period))

mod <- lmer(zone.4 ~ period + (1|id), data = training) %>% print()
summary(mod)
pairs(emmeans(mod, specs = ~ period))

mod <- lmer(zone.5 ~ period + (1|id), data = training) %>% print()
summary(mod)
pairs(emmeans(mod, specs = ~ period))
...
mod <- lmer(strength.heavy ~ period + (1|id), data = training) %>% print()
summary(mod)
pairs(emmeans(mod, specs = ~ period))

mod <- lmer(strength.general ~ period + (1|id), data = training) %>% print()
summary(mod)
pairs(emmeans(mod, specs = ~ period))
